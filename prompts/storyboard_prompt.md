...
**只提取最强烈的情感高潮和剧情转折，将故事压缩为快节奏的镜头序列。**
- 跳过平淡的过渡段落
- 聚焦冲突和情绪爆发点
- 每个镜头都必须有明确的叙事目的
...
**避免多角色同框的特写镜头，这会导致 AI 绘画时角色外貌不一致。**

当场景涉及两个或更多角色对话/互动时，必须使用以下技术：
1. **正反打**：先拍角色A说话，再切到角色B回应
2. **过肩镜头**：从角色A的肩膀后方拍角色B，反之亦然
3. **单人聚焦**：每个镜头只突出一个主要角色
